...
function helmGen (author, name, folder)
{
    ...
    let settings = [
        ...
        new helmSetting ( "osc_1_unison_detune", 0.0, 100.0, 0, 10.0, 'ONLYNONZERO', 1.0 ),
        new helmSetting ( "osc_1_unison_voices", 1.0, 15.0, 8, 1.0, 'ONLYNONZERO', 1.0 ),
        ...
        new helmSetting ( "osc_2_unison_detune", 0.0, 100.0, 0, 10.0, 'ONLYNONZERO', 1.0 ),
        new helmSetting ( "osc_2_unison_voices", 1.0, 15.0, 8, 1.0, 'ONLYNONZERO', 1.0 ),
        new helmSetting ( "osc_2_volume", 0.0, 1.0, 0, 0.5477225575, 'ALWAYS', 1.0 ),
        new helmSetting ( "osc_2_waveform", 0.0, 10.0, 11, 4.0, 'ALWAYS', 1.0 ),
        new helmSetting ( "osc_feedback_amount", -1.0, 1.0, 0, 0.0, 'ONLYNONZERO', 1.0 ),
